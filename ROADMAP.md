...
This roadmap outlines planned features, enhancements, and ideas for the skills-and-prompts repository. Community contributions and suggestions are welcome!

## How to Contribute Ideas

We welcome community input on our roadmap! Here's how you can participate:

1. **Submit Feature Requests**: Use our [Feature Request template](https://github.com/crashappsec/skills-and-prompts/issues/new?template=feature_request.md) to suggest new ideas
...
- **GitHub Issues**: [Create a feature request](https://github.com/crashappsec/skills-and-prompts/issues/new?template=feature_request.md)
- **GitHub Discussions**: [Join the conversation](https://github.com/crashappsec/skills-and-prompts/discussions)
