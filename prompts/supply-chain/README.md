...
Comprehensive prompt templates for Software Bill of Materials (SBOM) analysis, operations, security, and compliance using the Supply Chain Analyser skill.
...
1. **Load the Supply Chain Analyser Skill** in Crash Override
...
- Supply Chain Analyser skill loaded in Crash Override
...
### Skills
- [Supply Chain Analyser Skill](../../skills/supply-chain-analyser/) - Complete documentation
- [Examples](../../skills/supply-chain-analyser/examples/) - Sample SBOMs and reports
...
- Review [Supply Chain Analyser documentation](../../skills/supply-chain-analyser/README.md)
