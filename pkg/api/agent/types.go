...
func GetAgentInfo(agentID string) AgentInfo {
	agents := map[string]AgentInfo{
		...
		"cereal": {ID: "cereal", Name: "Cereal", Persona: "Cereal Killer", Description: "Supply chain security", Scanner: "package-analysis"},
		...
		"phreak": {ID: "phreak", Name: "Phreak", Persona: "Phantom Phreak", Description: "Legal, licenses, privacy", Scanner: "package-analysis"},
		...
		"gill":   {ID: "gill", Name: "Gill", Persona: "Gill Bates", Description: "Cryptography specialist", Scanner: "code-crypto"},
